...
const SIDEBAR_EXPANDED_WIDTH = "300px"
...
const SidebarContext = React.createContext<SidebarContextType | SidebarContextProps | undefined>(undefined)
  ...
  return (
    <>
      <motion.div
        ...
        animate={{
          width: animate ? (open ? SIDEBAR_EXPANDED_WIDTH : SIDEBAR_COLLAPSED_WIDTH) : SIDEBAR_EXPANDED_WIDTH,
        }}
